...
export default function Preloader() {
  ...
  // Reinicia el preloader de forma controlada previniendo el bucle en las vistas comerciales
  useEffect(() => {
    if (isMounted) {
      // Si el usuario está en la raíz idiomática comercial, frenar el re-encendido del preloader
      const isPublicLanding = pathname === '/es' || pathname === '/en' || pathname === '/';
      if (isPublicLanding && !loading) return;
