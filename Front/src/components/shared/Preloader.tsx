...
export default function Preloader() {
  ...
  // Solo ejecuta la pantalla de carga de 5 segundos en el montaje inicial de la app
  const [loading, setLoading] = useState(true);
  const [isMounted, setIsMounted] = useState(false);

  // Función síncrona y segura de desbloqueo global del DOM
  const releaseDOM = () => {
  ...
  useEffect(() => {
    ...
    // Si la ruta cambia internamente a través del menú, liberamos el DOM de forma aséptica e inmediata
    ...
    // Inicialización perimetral de bloqueo estricto en el primer renderizado
    if (typeof document !== 'undefined') {
