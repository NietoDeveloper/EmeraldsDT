...
export default async function Home({ params }: HomePageProps) {
  ...
  return (
    <main className="relative w-full bg-black h-screen overflow-y-auto snap-y snap-mandatory scroll-smooth select-none overflow-x-hidden">
      ...
      <section className="snap-start h-screen w-full flex items-center bg-black border-t border-emerald/10 relative overflow-hidden px-6 md:px-0">
        ...
        <div className="container mx-auto max-w-[1900px] px-4 md:px-20 relative z-10">
          <div className="max-w-4xl transition-all duration-1000">
            ...
            {/* Título Monumental Responsive (ajusta desde 310px) */}
            <h3 className="text-4xl sm:text-6xl md:text-8xl lg:text-[110px] font-black uppercase mb-8 tracking-tighter leading-[0.9] text-white">
              Muzo Star <br/> 
              <span className="text-white/40 italic font-light group-hover:text-white transition-all">
                Collection
              </span>
            </h3>
