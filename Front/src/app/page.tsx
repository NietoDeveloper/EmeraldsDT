"use client"; // Cambiamos a Client Component para asegurar la visualización inmediata de los estilos dinámicos de Tailwind

import { HeroSection } from '@/components/sections/HeroSection';
import { MainButton } from '@/components/ui/MainButton';
import { use } from 'react'; // Importamos use para manejar la promesa de params
    ...
    <div className="relative w-full bg-black select-none">
      ...
      {mines.map((mine, index) => (
        ...
        >
          ...
          <div className="absolute inset-0 z-0">
            ...
            <div 
              ...
              style={{ 
                ...
                backgroundColor: '#0a0a0a' // Color de respaldo mientras carga
              }}
            />
          </div>
          ...
          <div className="w-full px-6 sm:px-12 md:px-24 lg:px-32 xl:px-48 relative z-20">
            <div className="max-w-[1900px] mx-auto">
              <div className="max-w-4xl opacity-100 transition-opacity duration-1000">
                ...
                <h2 className="text-emerald-500 font-mono tracking-[0.4em] md:tracking-[0.6em] uppercase mb-4 text-[10px] md:text-xs font-bold">
                  {isEs ? `// Origen: Boyacá, Colombia` : `// Origin: Boyacá, Colombia`}
                </h2>
                
                <h3 className="text-5xl sm:text-7xl md:text-8xl lg:text-[100px] font-black uppercase mb-6 tracking-tighter leading-none text-white">
                  {mine.name} <br/> 
                  <span className="text-gold italic font-light text-2xl sm:text-3xl md:text-4xl tracking-normal block mt-2">
                    {isEs ? mine.tagEs : mine.tag}
                  </span>
                </h3>
                
                <p className="text-zinc-300 text-sm md:text-lg mb-10 max-w-xl leading-relaxed font-medium opacity-90">
          ...
          <div className="absolute right-8 md:right-16 bottom-32 hidden md:flex flex-col items-center gap-4 z-20">
            ...
            <div className="w-[1px] h-24 bg-gradient-to-b from-gold to-transparent opacity-50" />
          </div>
        </section>
      ))}
      ...
      <section className="relative w-full py-32 bg-black flex flex-col items-center text-center px-6 border-t border-white/5">
        <div className="max-w-3xl">
          <h4 className="text-emerald-500 text-[10px] tracking-[0.5em] uppercase font-bold mb-8">Earth's Natural Art</h4>
